...
const STUDIO_PACK_ART: PackArtItem[] = [
  ...
  { key: "chicken-puffs", label: "Chicken puffs", size: 28, ratio: 0.77, audience: ["kids"], group: "faces" },
  { key: "pizza-puffs", label: "Pizza puffs", size: 28, ratio: 0.774, audience: ["kids"], group: "faces" },
  { key: "ketchup-puffs", label: "Ketchup puffs", size: 26, ratio: 1, audience: ["kids"], group: "faces" },
  ...
  { key: "mystery-toy-mix", label: "Mystery toy mix", size: 30, ratio: 1.028, audience: ["kids"], group: "toys" },
