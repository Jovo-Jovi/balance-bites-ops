...
const PRESET_FILES: Record<string, string> = {
  ...
  "chicken-puffs": "bb-chicken-puffs.png",
  "pizza-puffs": "bb-pizza-puffs.png",
  "ketchup-puffs": "bb-ketchup-puffs.png",
  "mystery-toy-mix": "bb-mystery-toy-mix.png",
  ...
  "kids-car": "bb-kids-car.png",
  "kids-truck": "bb-kids-truck.png",
  "kids-horn": "bb-kids-horn.png",
  "kids-plane": "bb-kids-plane.png",
  "kids-ball": "bb-kids-ball.png",
  "kids-train": "bb-kids-train.png",
  "kids-blocks": "bb-kids-blocks.png",
...
const STUDIO_PACK_ART: PackArtItem[] = [
  ...
  { key: "chicken-puffs", label: "Chicken puffs", size: 24, ratio: 0.857, audience: ["kids"], group: "faces" },
  { key: "pizza-puffs", label: "Pizza puffs", size: 24, ratio: 0.741, audience: ["kids"], group: "faces" },
  { key: "ketchup-puffs", label: "Ketchup puffs", size: 24, ratio: 0.979, audience: ["kids"], group: "faces" },
  ...
  { key: "mystery-toy-mix", label: "Mystery toy mix", size: 28, ratio: 0.958, audience: ["kids"], group: "toys" },
  ...
  { key: "kids-car", label: "Car", size: 26, ratio: 1.198, audience: ["kids"], group: "toys" },
  { key: "kids-truck", label: "Truck", size: 26, ratio: 1.297, audience: ["kids"], group: "toys" },
  { key: "kids-horn", label: "Horn", size: 28, ratio: 1.824, audience: ["kids"], group: "toys" },
  { key: "kids-plane", label: "Plane", size: 26, ratio: 1.524, audience: ["kids"], group: "toys" },
  { key: "kids-ball", label: "Ball", size: 24, ratio: 1.0, audience: ["kids"], group: "toys" },
  { key: "kids-train", label: "Train", size: 26, ratio: 1.157, audience: ["kids"], group: "toys" },
  { key: "kids-blocks", label: "Blocks", size: 24, ratio: 0.534, audience: ["kids"], group: "toys" },
...
const PRESET_THUMB_FILL: Record<string, string> = {
  ...
  "chicken-face": "#f5f5f0",
  ketchup: "#c62828",
  "chicken-puffs": "#f4c430",
  "pizza-puffs": "#f4c430",
  "ketchup-puffs": "#c62828",
  "mystery-toy-mix": "#6b3a28",
  "toy-cup": "#fdd835",
  "roll-toy": "#fb8c00",
  pebble: "#6b3a28",
  "kids-cloud": "#fff4a3",
